...
Any Azure parameter can be retrieved from Secret Agent.
      ...
      --azure-request-timeout int      Timeout in seconds specifies a time limit for requests made by this Client.
                                       The timeout includes connection time, any redirects, and reading the response body.
                                       Zero means no limit. (default 600)
dneeman@Dmitriis-MacBook-Pro asbackup % cd ..
dneeman@Dmitriis-MacBook-Pro cmd % cd asrestore 
dneeman@Dmitriis-MacBook-Pro asrestore % make build
Building asrestore with version main...
go build -ldflags "-X 'main.appVersion=main' -X 'main.commitHash=24e889d' -X 'main.buildTime=2025-11-30T12:16:33Z'" -o asrestore main.go
dneeman@Dmitriis-MacBook-Pro asrestore % ./asrestore 
Welcome to the Aerospike restore CLI tool!
------------------------------------------
